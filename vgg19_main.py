...
from model2.vgg_19_qt1 import *
from model2.vgg_19_qt2 import *
...
def get_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg_19', choices=('resnet_56','vgg_16_bn'), help='The architecture to prune and the resulting model and logs will use this') 
    parser.add_argument('--resume', type=str, default='./model2/ckpt/vgg19_UCML.t7',help='load the model from the specified checkpoint')
    ...
    parser.add_argument("--rankPath", type=str, default='./rank_conv/UCML/vgg_19', help='The path of ranks of convolution layers')
    ...
    parser.add_argument("--lub", type=str, default='./log_0.025/vgg_19_UCML_ea_min.data', help='The affine transformations')
    parser.add_argument("--savename", type=str, default='vgg_19_UCML')
...
class LEDPQ:
    ...
    def learn_ranking_ea(self, name, model_desc, tau_hat, long_ft, flops_target, bops_target):
        ...
        for i in range(GENERATIONS):
            ...
            for j in range(len(bit)):
                ...
                if j == 1 or j == 3 or j == 7 or j == 11 or j == 15:
                    bit_all.append('M')
                # elif  j == 14:
                #     bit_all.append(32)
            qmodel = qvgg_19_bn_A_W(filters_left=sparse_channel, bit=bit_all).cuda()
            qmodel.to(device)
    ...
    def model_compress(self, name, long_ft, flops_target, bops_target, target=-1, arch =''):
        ...
        model_qt1 = qvgg_19_bn_A(filters_left=sparse_channel, bit=bit_all).cuda()
        ...
        model_qt2 = qvgg_19_bn_A_W(filters_left=sparse_channel, bit=bit_all).cuda()
...
if __name__ == "__main__":
    ...
    # filter_pruner = eval('FilterPrunerVGG')(basemodel, 'Rank', num_cls=21, rankPath=args.rankPath, device=device)
