...
from backbone.darknet import Conv_BN_LeakyReLU

class FilterPrunerYOLOv3tiny(FilterPruner):
    ...
    def forward(self, x):
        ...
        for l1, m1 in enumerate(model.children()):
            if isinstance(m1, Conv_BN_LeakyReLU):
