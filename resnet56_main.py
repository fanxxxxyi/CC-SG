...
from model.resnet_cifar_qt1 import *
from model.resnet_cifar_qt2 import *
...
def get_args():
    ...
    parser.add_argument('--arch', type=str, default='resnet_56', choices=('resnet_56','vgg_16_bn'), help='The architecture to prune and the resulting model and logs will use this') 
    parser.add_argument('--resume', type=str, default='./model2/ckpt/resnet56_UCML.t7',help='load the model from the specified checkpoint')
    ...
    parser.add_argument("--rankPath", type=str, default='./rank_conv/UCML/resnet_56', help='The path of ranks of convolution layers')
    parser.add_argument("--rank_type", type=str, default='Rank',choices=('l1_bn','l2_bn','l1_weight','l2_weight', 'HRank'), help='The ranking criteria for filter pruning')
    parser.add_argument("--lub", type=str, default='./log_0.025/resnet_56_UCML_ea_min.data', help='The affine transformations')
...
class LEDPQ:
    ...
    def learn_ranking_ea(self, name, model_desc, tau_hat, long_ft, flops_target, bops_target):
        ...
        for i in range(GENERATIONS):
            ...
            qmodel = qresnet_56_A_W(num_classes=21, filters_left=sparse_channel, bit=bit).cuda()
            qmodel.to(device)
            ...
            model = resnet_56(num_classes=21).cuda()
    ...
    def model_compress(self, name, long_ft, flops_target, bops_target, target=-1, arch =''):
        ...
        model_qt1 = qresnet_56_A(num_classes=21, filters_left=sparse_channel, bit=bit).cuda()
        ...
        model_qt2 = qresnet_56_A_W(num_classes=21, filters_left=sparse_channel, bit=bit).cuda()
...
if __name__ == "__main__":
    ...
    # model
    basemodel = resnet_56(num_classes=21).cuda()
