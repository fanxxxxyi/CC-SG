...
class QVGG_A(nn.Module):
    def __init__(self, num_classes, init_weights, cfg, filters_left,ka,kw):
        ...
        if cfg is None:
            cfg = [filters_left[0], filters_left[1], 'M', filters_left[2], filters_left[3], 'M', filters_left[4], filters_left[5], filters_left[6], filters_left[7], 'M',  filters_left[8], filters_left[9], filters_left[10], filters_left[11], 'M', filters_left[12], filters_left[13], filters_left[14], filters_left[15], 'M']
...
def qvgg_19_bn_A(filters_left, bit):
    return QVGG_A(num_classes=21, init_weights=True, cfg=None, filters_left=filters_left,ka=bit, kw=bit)
